...
PyTorch implementation of [DeepEMD: Few-Shot Image Classification with Differentiable Earth Mover's Distance and Structured Classifiers](https://arxiv.org/pdf/2003.06777v2.pdf)" (CVPR 2020 oral [(oral video)](https://www.youtube.com/watch?v=X2ZUZYy_GtY) ) and"[DeepEMD: Differentiable Earth Mover's Distance for Few-Shot Learning](https://arxiv.org/pdf/2003.06777.pdf)" (Extension). 
